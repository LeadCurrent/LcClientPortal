...
namespace Web.Controllers
{
    ...
    public class PricingController : Controller
    {
        ...
        public async Task<IActionResult> Contact(ContactsVM ViewModel, string Action)
        {
            try
            {
                if (ViewModel.Total != ViewModel.TotalInput)
                {
                ...
                if (!captchaResult.Success)
                {
                    ...
                    return RedirectToAction("Index", "Pricing", new { Robot = true });
                }
                ...
                return RedirectToAction("Index", "Pricing", new { ContactSent = true });
