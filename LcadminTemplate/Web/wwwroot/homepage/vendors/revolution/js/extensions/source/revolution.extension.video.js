	...
	manageVideoLayer : function(_nc,opt,recalled,internrecalled) {	
		...
		switch (newvideotype) {
			case "html5":
				...
				var apptxt = '<'+tag+' style="object-fit:cover;background-size:cover;visible:hidden;width:100%; height:100%" '+videoloop+' preload="'+videopreload+'">';
				...
				if (videoafs==="true" ||  videoafs===true)
					hfm = '<div class="tp-video-button-wrap"><button  class="button"  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div>';

				if (videocontrols=="controls")
					apptxt = apptxt + ('<div class="tp-video-controls">'+
										  '<div class="tp-video-button-wrap"><button  class="button" type="button" class="tp-video-button tp-vid-play-pause">Play</button></div>'+
										  '<div class="tp-video-seek-bar-wrap"><input  type="range" class="tp-seek-bar" value="0"></div>'+
										  '<div class="tp-video-button-wrap"><button  class="button"  type="button" class="tp-video-button tp-vid-mute">Mute</button></div>'+
